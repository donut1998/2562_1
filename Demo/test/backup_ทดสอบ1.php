...
<html>
  ...
  <body>
    ...
    <?php
        ...
        //  $current_latitude =  ($data -> {'truck_1'} -> {'last_pos'} -> {'lat'});
        //  $current_longtitude = ($data -> {'truck_1'} -> {'last_pos'} -> {'long'});
        //  echo '<script type="text/javascript">';
        //  echo "var current_latitude = '$current_latitude';"; // ส่งค่า $data จาก PHP ไปยังตัวแปร data ของ Javascript
        //  echo '</script>';
        //  echo '<script type="text/javascript">';
        //  echo "var current_longtitude = '$current_longtitude';"; // ส่งค่า $data จาก PHP ไปยังตัวแปร data ของ Javascript
        //  echo '</script>';
    ?>
